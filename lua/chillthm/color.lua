...
C.colors = function(m)
  ...
  local c = {
    ...
    ["comment"] = COLORS[m]["comment"],
    ["commentTodo"] = COLORS[m]["commentTodo"],
    ["commentError"] = COLORS[m]["commentError"],
    ["commentWarn"] = COLORS[m]["commentWarn"],
    ["commentInfo"] = COLORS[m]["commentInfo"],
    ["commentHint"] = COLORS[m]["commentHint"],
